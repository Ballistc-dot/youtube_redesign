...
import {
  ...
  TopBarMiddleItens,
  TabSubscriptions,
  TabSubscriptionsItens,
  TabSubscriptionsTitle,
  TabSubscriptionsImage,
  TabMoreFromYt,
  TabMoreFromYtTitle,
  TabMoreFromYtItens,
} from './styles';
...
const TabBar: React.FC = () => {
  return (
    <Container>
      ...
      <TopBarMiddle>
        <TopBarMiddleItens>
          <FolderOutlined id="logo" />
          Library
        </TopBarMiddleItens>
        <TopBarMiddleItens>
          <HistoryOutlined id="logo" />
          History
        </TopBarMiddleItens>
        <TopBarMiddleItens>
          <WatchLaterOutlined id="logo" />
          Watch later
        </TopBarMiddleItens>
        <TopBarMiddleItens>
        ...
        <TopBarMiddleItens id="show_more">
          <ExpandMoreOutlined id="logo" />
          Show More
        </TopBarMiddleItens>
      </TopBarMiddle>
      <TabSubscriptions>
        <TabSubscriptionsTitle>Subscriptions</TabSubscriptionsTitle>
        <TabSubscriptionsItens>
          <TabSubscriptionsImage src="https://i.picsum.photos/id/853/200/200.jpg?hmac=f4LF-tVBBnJb9PQAVEO8GCTGWgLUnxQLw44rUofE6mQ" />
          YouTube
        </TabSubscriptionsItens>
        <TabSubscriptionsItens>
          <TabSubscriptionsImage src="https://i.picsum.photos/id/853/200/200.jpg?hmac=f4LF-tVBBnJb9PQAVEO8GCTGWgLUnxQLw44rUofE6mQ" />
      ...
      <TabMoreFromYt>
        <TabMoreFromYtTitle>More from youtube</TabMoreFromYtTitle>
        <TabMoreFromYtItens>
          <SettingsOutlined id="logo" />
          Settings
        </TabMoreFromYtItens>
        <TabMoreFromYtItens>
          <ErrorOutlineOutlined id="logo" />
          Send Feedback
        </TabMoreFromYtItens>
      </TabMoreFromYt>
    </Container>
